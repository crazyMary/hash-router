...
!(function(template) {
  ...
  deepCopy = function(source) {
    ...
    for (var key in source) {
      ...
      ret[key] = toString.call(value) === '[object Object]' ? arguments.callee(value) : toString.call(value) === '[object Array]' ? value.concat() : value
    }
    return ret;
  };
  // 是否为function
  ...
  (function() {
    if (typeof module !== 'undefined' && typeof exports === 'object') { //CommonJS
